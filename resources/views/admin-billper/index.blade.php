    ...
    <div class="px-3 py-4">
        ...
        <div class="dashbooard-admin-wraper">
            ...
            <div class="row mb-0 mb-xl-3">
                <div class="col-12 col-xl-6 mb-3 mb-xl-0">
                    <div class="card border border-0 shadow shadow-sm rounded-4 px-3 py-3">
                        @include('components.admin-analisis-data-billper')
                    </div>
                </div>
                <div class="col-12 col-xl-6 mb-3 mb-xl-0">
                    <div class="card border border-0 shadow shadow-sm rounded-4 px-3 py-3">
            ...
            <div class="row">
                <div class="col-12 col-xl-6 mb-3 mb-xl-0">
                    <div class="card border border-0 shadow shadow-sm rounded-4 px-3 py-3">
                        @include('components.admin-tabel-pending-billperexsititng')
                    </div>
                </div>
                <div class="col-12 col-xl-6 mb-3 mb-xl-0">
                    <div class="card border border-0 shadow shadow-sm rounded-4 px-3 py-3">
                        <div class="d-flex justify-content-between w-100 mb-3">
                            ...
                            <div class="text-right">
                                <span class="fw-bold fs-2">
                                    {{ number_format($totalVisitbillperexistingSales, 0, ',', '.') }}
                                    <span class="fs-5">
                                        Visit
                                    </span>
                                </span>
                        ...
                        <div class="d-flex flex-column content-2">
                            ...
                            <div class="d-flex flex-column flex-xl-row">
                                <div class="card border border-0 shadow shadow-sm rounded-4 px-3 w-100 me-3 mb-3 mb-xl-0">
                                    @include('components.adminbillper-aktivitas-tertinggi-data-billper')
                                </div>
                                <div class="card border border-0 shadow shadow-sm rounded-4 px-3 w-100 me-3 mb-3 mb-xl-0">
                                    @include('components.adminbillper-aktivitas-tertinggi-data-existing')
                                </div>
                            </div>
                            <div class="head-progres-sales text-center my-5">
                            ...
                            <div class="d-flex flex-column flex-xl-row">
                                <div class="card border border-0 shadow shadow-sm rounded-4 px-3 w-100 me-3 mb-3 mb-xl-0">
                                    @include('components.adminbillper-aktivitas-terendah-data-billper')
                                </div>
                                <div class="card border border-0 shadow shadow-sm rounded-4 px-3 w-100 me-3 mb-3 mb-xl-0">
                                    @include('components.adminbillper-aktivitas-terendah-data-existing')
                                </div>
                            </div>
                        </div>
                    </div>
