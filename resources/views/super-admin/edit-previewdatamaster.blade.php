            ...
            <div class="card px-3 py-4 shadow">
                <div class="card-body">
                    ...
                    <div class="contain-form">
                        <form action="{{ route('update-previewdatamasters', ['id' => $preview_data_master->id]) }}"
                            method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="mobile_contact_tel"
                                            ...
                                            value="{{ $preview_data_master->mobile_contact_tel }}">
                                    </div>
                                    <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-center">
                                <a href="{{ route('previewdatamaster.index') }}" class="btn btn-grey me-2 px-5">Batal</a>
