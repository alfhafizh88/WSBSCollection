...
@section('content')
    <div class="px-4 py-4 card shadow shadow-sm border border-0 rounded-4 mb-3">
        ...
        {{-- Filter Form --}}
        <form id="filterForm" action="{{ route('reportsalesexisting.index') }}" method="GET">
            <div class="row mb-3">
                <div class="col-md-4">
    ...
    <div class="px-4 py-4 card shadow shadow-sm border border-0 rounded-4">
        ...
        <div class="mt-5 mb-2 d-flex justify-content-between align-items-center">
            ...
            <div class="btn-group">
                <a href="{{ route('download.excelreportexistingsuperadmin') }}" class="btn btn-green">
                ...
                <ul class="dropdown-menu p-3">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form id="downloadForm" action="{{ route('download.filtered.excelreportexistingsuperadmin') }}"
                                method="POST">
                                @csrf
        ...
        {{-- New Table --}}
        <table class="table table-hover table-bordered datatable shadow" id="datareportexistingsuperadmin"
            style="width: 100%">
            <thead>
                <tr>
...
@push('scripts')
    <script type="module">
        document.addEventListener('DOMContentLoaded', function() {
            var dataTable = new DataTable('#datareportexistingsuperadmin', {
                serverSide: true,
                processing: true,
                pagingType: "simple_numbers",
                responsive: true,
                ajax: {
                    url: "{{ route('getDatareportexistingsuperadmin') }}",
                    type: 'GET',
                    data: function(d) {
