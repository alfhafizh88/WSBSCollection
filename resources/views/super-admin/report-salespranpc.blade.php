...
@section('content')
    <div class="px-4 py-4 card shadow shadow-sm border border-0 rounded-4 mb-3">
        ...
        {{-- Filter Form --}}
        <form id="filterForm" action="{{ route('reportsalespranpc.index') }}" method="GET">
            <div class="row mb-3">
                <div class="col-md-3">
...
@push('scripts')
    <script type="module">
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var dataTable = new DataTable('#datareportpranpcsuperadmin', {
                serverSide: true,
                processing: true,
                pagingType: "simple_numbers",
                responsive: true,
                ajax: {
                    url: "{{ route('getDatareportpranpcsuperadmin') }}",
                    type: 'GET',
                    data: function(d) {
