<div class="d-flex justify-content-left align-items-center gap-2">
    <a href="{{ route('edit-existings', ['id' => $existing->id]) }}" class="btn border border-0 d-flex align-items-center">
        <div class="text-blue">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="pdfForm{{ $existing->id }}" action="{{ route('existing.pdf', ['id' => $existing->id]) }}"
                        method="GET">
                        <div class="mb-3">
    ...
    <form action="{{ route('destroy-existings', ['id' => $existing->id]) }}" method="POST" class="delete-form">
        @csrf
        @method('delete')
