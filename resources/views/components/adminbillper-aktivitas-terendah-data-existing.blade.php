<div class="d-flex justify-content-between align-items-center">
    ...
    <a href="{{ route('report-existing-adminbillper.index') }}" class="">
        <i class="bi bi-three-dots fw-bold fs-4 text-dark"></i>
    </a>
</div>

<div class="contain-progress-sales">
    @foreach ($salesexistingterendah as $sale)
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <div class="progress w-50" role="progressbar" aria-label="Example with label"
                ...
                @endphp
                <div class="progress-bar" id="bg-secondary" style="width: {{ $progress }}%">
                    {{ round($progress, 2) }}%</div>
            </div>
